...
function PlaybackControls({ playing, toggle, speed, setSpeed, progress, seek, disabled = false }) {
  ...
  return (
    <ArgonBox display="flex" alignItems="center" gap={2} px={1} py={1} flexWrap="wrap">
      ...
      <ToggleButtonGroup
        ...
        onChange={(event, value) => value && setSpeed(value)}>
      ...
      <ArgonBox flex={1} minWidth="160px" px={1}>
        <Slider
          ...
          onChange={(event, value) => seek(value / 100)}
        />
      </ArgonBox>
    </ArgonBox>
  );
