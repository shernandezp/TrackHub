...
function CompactSelect({ name, value, options, label, onChange }) {
  const labelFor = (selected) => {
...
FilterBar.propTypes = {
  ...
  onTogglePois: PropTypes.func,
  followMode: PropTypes.bool,
  onToggleFollow: PropTypes.func,
  followDisabled: PropTypes.bool,
  showTrail: PropTypes.bool,
  onToggleTrail: PropTypes.func
};
