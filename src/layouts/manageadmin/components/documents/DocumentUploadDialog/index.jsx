...
function DocumentUploadDialog({ open, setOpen, onUpload, categories, replaceMode }) {
  const { t } = useTranslation();
  const [values, handleChange, setValues, setErrors, validate, errors] = useForm({ classification: 'Internal' });
  ...
  const pickFile = (selected) => { if (selected) setFile(selected); };
...
DocumentUploadDialog.defaultProps = {
  categories: [],
  replaceMode: false,
};
