...
function PoiFormDialog({ open, setOpen, handleSubmit, values, handleChange, errors, groupOptions }) {
  const { t } = useTranslation();
  const translatedTypes = poiTypes.map(type => ({
    ...type,
    label: t(`poi.types.${toCamelCase(type.label)}`)
  }));
