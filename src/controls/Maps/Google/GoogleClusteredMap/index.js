...
const AnimatedGoogleMarker = ({ data, clusterer, animate, title, icon, onClick, children }) => {
    const [position, setPosition] = useState({ lat: data.lat, lng: data.lng });
    const positionRef = useRef({ lat: data.lat, lng: data.lng });
...
AnimatedGoogleMarker.propTypes = {
...
const MarkerInfoContent = ({ marker, t, onResolveAddress, resolveState }) => {
...
MarkerInfoContent.propTypes = {
    marker: PropTypes.object.isRequired,
    t: PropTypes.func.isRequired,
    onResolveAddress: PropTypes.func,
    resolveState: PropTypes.string
};
