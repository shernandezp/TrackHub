...
/**
 * Transporter-type GraphQL documents (Manager backend). Codegen validates these
...
export const TransporterTypeItemFragment = graphql(`
...
export const GetTransporterTypesDocument = graphql(`
...
export const UpdateTransporterTypeDocument = graphql(`
