...
export type NotificationRuleItemFragment = { notificationRuleId: string, accountId: string, ruleKey: string, ruleType: string, enabled: boolean, triggerEvent: string, recipientSelector: string, channelsJson: string, lastModified: string };
...
export type GetNotificationRulesQuery = { notificationRules: Array<{ notificationRuleId: string, accountId: string, ruleKey: string, ruleType: string, enabled: boolean, triggerEvent: string, recipientSelector: string, channelsJson: string, lastModified: string }> };
...
export type ReportFieldsFragment = { reportId: string, code: string, description: string | null, type: ReportType, typeId: number, active: boolean };

export type GetReportsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetReportsQuery = { reports: Array<{ reportId: string, code: string, description: string | null, type: ReportType, typeId: number, active: boolean }> };
