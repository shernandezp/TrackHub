...
public static class CorsConfigurationExtensions
{
    ...
    /// <summary>Reads <c>AllowedCorsOrigins</c> as a list: a JSON array, or one comma-separated string.</summary>
    public static string[] GetAllowedCorsOrigins(this IConfiguration configuration)
    {
        var section = configuration.GetSection(AllowedCorsOriginsKey);

        if (section.Value is { } scalar)
        {
