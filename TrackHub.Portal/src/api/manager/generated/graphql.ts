...
export type AccountItemFragment = { accountId: string, name: string, description: string | null, type: AccountType, typeId: number, status: AccountStatus, statusId: number, active: boolean, timeZoneId: string, lastModified: string };

export type GetAccountByUserQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAccountByUserQuery = { accountByUser: { accountId: string, name: string, description: string | null, type: AccountType, typeId: number, status: AccountStatus, statusId: number, active: boolean, timeZoneId: string, lastModified: string } };
...
export type GetAccountsQuery = { accounts: { totalCount: number, items: Array<{ accountId: string, name: string, description: string | null, type: AccountType, typeId: number, status: AccountStatus, statusId: number, active: boolean, timeZoneId: string, lastModified: string }> } };
...
export type CreateAccountMutation = { createAccount: { accountId: string, name: string, description: string | null, type: AccountType, typeId: number, status: AccountStatus, statusId: number, active: boolean, timeZoneId: string, lastModified: string } };
...
export type ChangeAccountStatusMutation = { changeAccountStatus: { accountId: string, name: string, description: string | null, type: AccountType, typeId: number, status: AccountStatus, statusId: number, active: boolean, timeZoneId: string, lastModified: string } };

export type GetAccountContextQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAccountContextQuery = { accountContext: { status: AccountStatus, statusId: number, timeZoneId: string, branding: { accountId: string, displayName: string, logoDocumentId: string | null, primaryColor: string, reportHeader: string | null, lastModified: string }, features: Array<{ accountFeatureId: string, accountId: string, featureKey: string, enabled: boolean, tier: string, source: string, effectiveFrom: string | null, effectiveTo: string | null, configurationJson: string | null, lastModified: string }> } };
...
export type GetAuditTrailQuery = { auditTrailFeed: { hasMore: boolean, nextCursor: string | null, items: Array<{ auditEventId: string, accountId: string, actorType: string, actorId: string, action: string, resourceType: string, resourceId: string, result: string, reason: string | null, correlationId: string | null, occurredAt: string }> } };
...
export const GetAuditTrailDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetAuditTrail"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"accountId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UUID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"cursor"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"take"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"auditTrailFeed"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"query"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"accountId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"accountId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"cursor"},"value":{"kind":"Variable","name":{"kind":"Name","value":"cursor"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"take"},"value":{"kind":"Variable","name":{"kind":"Name","value":"take"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AuditEventItem"}}]}},{"kind":"Field","name":{"kind":"Name","value":"hasMore"}},{"kind":"Field","name":{"kind":"Name","value":"nextCursor"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AuditEventItem"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"AuditEventVm"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"auditEventId"}},{"kind":"Field","name":{"kind":"Name","value":"accountId"}},{"kind":"Field","name":{"kind":"Name","value":"actorType"}},{"kind":"Field","name":{"kind":"Name","value":"actorId"}},{"kind":"Field","name":{"kind":"Name","value":"action"}},{"kind":"Field","name":{"kind":"Name","value":"resourceType"}},{"kind":"Field","name":{"kind":"Name","value":"resourceId"}},{"kind":"Field","name":{"kind":"Name","value":"result"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"correlationId"}},{"kind":"Field","name":{"kind":"Name","value":"occurredAt"}}]}}]} as unknown as DocumentNode<GetAuditTrailQuery, GetAuditTrailQueryVariables>;
